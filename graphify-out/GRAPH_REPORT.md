...
## Corpus Check
- 256 files · ~552,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1572 nodes · 3688 edges · 116 communities (89 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2563b4af`
...
Cohesion: 0.09
Nodes (41): LevelUpModal, BATTLE_MASTER_MANEUVERS, DIVINE_AFFINITY_OPTIONS, DivineAffinityOption, DRACONIC_ANCESTRY_OPTIONS, DraconicAncestryOption, ELDRITCH_INVOCATIONS, filterAvailableSpells() (+33 more)

### Community 3 - "dnd-types.ts"
Cohesion: 0.10
Nodes (33): DnDCharacterSheet(), fetchShare(), getThirdCasterSpellSlots(), applyLongRest(), applyRaceTemplate(), applyShortRest(), ARMOR_AC_MAP, ArmorModeOption (+25 more)

### Community 4 - "[code]/page.tsx"
Cohesion: 0.23
Nodes (28): borders(), dCell(), hCell(), isSafeImageUrl(), normalizeCharacter(), POST(), sectionHeader(), textPara() (+20 more)
...
Cohesion: 0.14
Nodes (28): EquipmentPaperDoll(), canToggleWeaponGrip(), applyClassTemplate(), createDefaultCharacter(), getEffectiveSpeed(), normalizeAbilityName(), TraitItem, calculateEquipmentBonuses() (+20 more)
...
Cohesion: 0.12
Nodes (27): DndEncyclopediaModal, RestModal, CompendiumBookIcon(), CrownRulerIcon(), DeviceStoneIcon(), EyeMysticIcon(), HeartGemIcon(), HourglassIcon() (+19 more)
...
Cohesion: 0.14
Nodes (16): BLADESINGING_WEAPONS, getClassSubclassLevel(), WARLOCK_PACT_SPELL_SLOTS, ClassEquipmentChoice, ClassStartingEquipmentData, DND_COMPENDIUM_CLASSES, findClassById(), findClassByName() (+8 more)

### Community 64 - "EquipmentSlotModal.tsx"
Cohesion: 0.13
Nodes (20): EFFECT_TYPES, EquipmentSlotModal(), EquipmentSlotModalProps, formatEffectBadge(), ITEM_RARITIES, SLOT_PRESETS, DND_COMPENDIUM_ITEMS, DND_WEAPON_COMPENDIUM_ITEMS (+12 more)

### Community 65 - "class-spells.ts"
Cohesion: 0.15
Nodes (18): getLevelUpChoicesConfig(), getAutoGrantedSpellsForLevel(), getAvailableSpellsForCharacter(), getMaxAvailableSpellSlotLevel(), isSpellAllowedForCharacter(), isSpellLevelAllowedForCharacter(), SpellCheckResult, SUBCLASS_EXPANDED_SPELLS (+10 more)
...
Cohesion: 0.15
Nodes (16): DetailsSheetPage, CameraPortraitIcon(), CoinsChestIcon(), EquipmentPaperDollProps, LevelUpModalProps, ConditionsTracker(), ConditionsTrackerProps, LevelDownModalProps (+8 more)
...
Cohesion: 0.10
Nodes (34): react-dom, SpellsSheetPage, AutocompleteInput(), AutocompleteInputProps, AutocompleteItem, calculateDropdownPosition(), DropdownPosition, SpellModalProps (+26 more)

### Community 78 - "app/page.tsx"
Cohesion: 0.09
Nodes (34): AuthModal, CharacterCreationWizardModal, CreateChoiceModal, EquipmentPaperDoll, LevelDownModal, LevelHistoryModal, NonClassSpellConfirmModal, ResetModal (+26 more)
...
Cohesion: 0.21
Nodes (20): RestModal(), ARTIFICER_SPELL_SLOTS, DND_CLASS_PROGRESSION, FULL_CASTER_SPELL_SLOTS, HALF_CASTER_SPELL_SLOTS, isClassSubclassMilestone(), CLASS_TEMPLATES, getHitDiceNotation() (+12 more)

### Community 84 - "BuffPotion"
Cohesion: 0.21
...
Cohesion: 0.17
Nodes (22): LevelUpModal, BARD_SPELLS_KNOWN, CLASS_CANTRIPS_PROGRESSION, CLASS_NAME_MAP, CLASS_SPELLS_KNOWN_TABLES, ClassFeatureEntry, ClassLevelProgression, getCantripsKnownForLevel() (+14 more)
...
Cohesion: 0.11
Nodes (25): ALL_ARTISAN_TOOLS, ALL_DND_LANGUAGES, BackgroundLanguageChoiceConfig, BackgroundSkillResolution, ClassLevel1ChoicesConfig, ClassSkillConfig, ClassSpellcastingLimits, DRAGON_ANCESTRIES (+17 more)
...
Cohesion: 0.22
Nodes (20): CharacterCreationWizardModal(), calcPointBuyTotalSpent(), calcPreparedSpellsLimit(), generateFantasyName(), getBackgroundLanguageChoiceConfig(), getClassSkillConfig(), getClassSpellcastingLimits(), getRacialChoicesConfig() (+12 more)
...
Cohesion: 0.07
Nodes (34): NameGeneratorModal, RaceSelectorModal, SpellDetailModal, StatsCalculatorModal, SubclassSelectorModal, TraitDetailModal, WeaponDetailModal, SpellDetailModal() (+26 more)
...
### Community 110 - "PotionItemModel"
Cohesion: 0.18
Nodes (3): OFFICIAL_EQUIPMENT_PACKS, itemRegistry, PotionItemModel

### Community 111 - "inventory-ui-and-manager.test.ts"
Cohesion: 0.14
...
### Community 113 - "InventoryManager.tsx"
Cohesion: 0.36
...
### Community 114 - "races.ts"
Cohesion: 0.29
Nodes (5): StatsCalculatorModal(), getRacialBonusConfig(), DND_COMPENDIUM_RACES, findRaceByName(), formatAbilityBonus()

### Community 115 - "background-equipment-parser.ts"
Cohesion: 0.38
Nodes (6): capitalizeFirst(), generateItemId(), KNOWN_GEAR_IDS, parseSingleGearItem(), splitEquipmentString(), GearUnit

## Knowledge Gaps
- **591 isolated node(s):** `SCREENSHOT_DIR`, `eslintConfig`, `nextConfig`, `name`, `version` (+586 more)
...
- **Why does `react` connect `react` to `package.json`, `EquipmentSlotModal.tsx`, `LevelUpModal.tsx`, `useEscapeKey`, `[code]/page.tsx`, `CharacterData`, `CharacterGridModal.tsx`, `CharacterCreationWizardModal.tsx`, `../src/components/sheet/pages/MainSheetPage.js`, `app/page.tsx`, `equipment-types.ts`, `InventoryManager.tsx`, `dnd-icons.tsx`, `ClassSelectorModal.tsx`?**
