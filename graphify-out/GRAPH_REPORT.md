...
## Corpus Check
- 219 files · ~492,365 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1366 nodes · 3125 edges · 102 communities (74 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `51b3bdcc`
...
Cohesion: 0.20
Nodes (20): CharacterCreationWizardModal, CharacterCreationWizardModal(), calcPointBuyTotalSpent(), calcPreparedSpellsLimit(), generateFantasyName(), getClassSkillConfig(), getClassSpellcastingLimits(), getRacialBonusConfig() (+12 more)
...
Cohesion: 0.16
Nodes (17): DetailsSheetPage, NameGeneratorModal(), DND_COMPENDIUM_NAMES_DB, FANTASY_NAMES_DATABASE, generateFantasyName(), generateMultipleFantasyNames(), generateRaceFantasyName(), getAvailableCultures() (+9 more)
...
Cohesion: 0.22
Nodes (16): getWeaponDamageDiceForGrip(), getTotalScore(), normalizeAbilityName(), calculateEquipmentBonuses(), deleteCustomItem(), equipItem(), EquipmentSlotConfig, EquippedItem (+8 more)
...
Cohesion: 0.11
Nodes (34): @supabase/supabase-js, RestModal, ShareModal, ChestIcon(), CompendiumBookIcon(), CrownRulerIcon(), CrystalBallDndIcon(), DeviceStoneIcon() (+26 more)
...
Cohesion: 0.17
Nodes (9): NameGeneratorModal, StatsCalculatorModal, SparklesDndIcon(), NameGeneratorModalProps, CalculatorTab, POINT_BUY_COST, STANDARD_ARRAY_VALUES, StatsCalculatorModalProps (+1 more)
...
Cohesion: 0.13
Nodes (21): METAMAGIC_OPTIONS, AutoGrantedSpell, getAutoGrantedSpellsForLevel(), HALF_CASTER_SPELL_SLOTS, getAvailableSpellsForCharacter(), getMaxAvailableSpellSlotLevel(), isSpellAllowedForCharacter(), isSpellLevelAllowedForCharacter() (+13 more)
...
Cohesion: 0.12
Nodes (26): EquipmentPaperDoll, EquipmentPaperDoll(), EFFECT_TYPES, EquipmentSlotModal(), EquipmentSlotModalProps, formatEffectBadge(), ITEM_RARITIES, SLOT_PRESETS (+18 more)

### Community 68 - "dnd-types.ts"
Cohesion: 0.11
Nodes (37): normalizeCharacter(), POST(), DnDCharacterSheet(), normalizeCharacterData(), RestModal(), TemplateModal, StatsCalculatorModal(), applyClassTemplate() (+29 more)
...
Cohesion: 0.24
Nodes (4): BackgroundSkillResolutionParams, CompendiumBackground, ALL_SKILLS, SkillName
...
Cohesion: 0.13
Nodes (18): CharacterGridModal, EquipmentPaperDollProps, RestModalProps, LevelDownModalProps, LevelHistoryModalProps, NonClassSpellConfirmModalProps, DetailsSheetPageProps, CharacterGridModal (+10 more)
...
Cohesion: 0.12
Nodes (23): ALL_ARTISAN_TOOLS, ALL_DND_LANGUAGES, BackgroundSkillResolution, ClassLevel1ChoicesConfig, ClassSkillConfig, ClassSpellcastingLimits, DRAGON_ANCESTRIES, DragonAncestryOption (+15 more)
...
### Community 97 - "ScrollIcon"
Cohesion: 0.40
Nodes (4): QuillIcon(), ScrollIcon(), SheetFooter, SheetFooterProps
...
- **Why does `react` connect `react` to `package.json`, `CompendiumModals.tsx`, `RaceSelectorModal.tsx`, `EquipmentSlotModal.tsx`, `[code]/page.tsx`, `LevelUpModal.tsx`, `ScrollIcon`, `CharacterCreationWizardModal.tsx`, `CharacterData`, `app/page.tsx`, `dnd-icons.tsx`, `SheetModals.tsx`, `StatsCalculatorModal.tsx`?**
