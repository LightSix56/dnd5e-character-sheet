    ...
    <div className="parchment-card p-4 sm:p-6 rounded-xl border-2 border-[#C9A84C] shadow-xl text-[#3D2012]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start relative">
        ...
        <div className="lg:col-span-4 flex flex-col items-center justify-between order-1 lg:order-2 py-1">
          {/* Mannequin figure container: tall with soft warm ambient backlight */}
          <div className="relative w-full max-w-[240px] sm:max-w-[270px] lg:max-w-[280px] h-[470px] sm:h-[500px] lg:h-[520px] flex items-center justify-center select-none">
