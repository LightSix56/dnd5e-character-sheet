...
export const SUBCLASS_EXPANDED_SPELLS: Record<string, string[]> = {
  ...
  'бездонный': [
    'Создание или уничтожение воды', 'Громовая волна', 'Порыв ветра', 'Отражение',
    'Метель', 'Молния', 'Контроль воды', 'Черные щупальца Эварда',
    'Конус холода', 'Водоворот'
  ],
  'бессмертный': [
    'Ложная жизнь', 'Луч болезни', 'Слепота/глухота', 'Тишина',
    'Притворная смерть', 'Разговор с мертвыми', 'Защита от смерти', 'Аура жизни',
    'Возрождение', 'Облако смерти'
  ],

  // ── ПАЛАДИН: Клятвы ──
  'клятва преданности': [
    'Защита от Зла и Добра', 'Убежище', 'Малое восстановление', 'Зона правды',
  ...
  'клятва короны': [
    'Приказ', 'Порицание', 'Удержание личности', 'Зона правды',
    'Аура жизненной силы', 'Духовные стражи', 'Изгнание', 'Страж веры',
    'Круг силы', 'Освящение'
  ],
  'клятва покорения': [
  ...
  'клятва искупления': [
    'Убежище', 'Усыпление', 'Спокойствие', 'Удержание личности',
    'Контрзаклинание', 'Гипнотический узор', 'Отилюков упругий шар', 'Каменная кожа',
    'Удержание чудовища', 'Стена силового поля'
  ],
  'клятва славы': [
    'Направляющий луч', 'Героизм', 'Усиление характеристики', 'Магическое оружие',
    'Ускорение', 'Защита от стихий', 'Принуждение', 'Свобода движений',
    'Общение', 'Огненный удар'
  ],
  'клятва часовых': [
    'Сигнал тревоги', 'Обнаружение магии', 'Лунный луч', 'Видение невидимого',
    'Контрзаклинание', 'Необнаружимость', 'Аура чистоты', 'Изгнание',
    'Удержание чудовища', 'Сцинтиллирующий взор'
  ],
  'клятвопреступник': [
  ...
  // ── СЛЕДОПЫТ: Архетипы ──
  'сумрачный охотник': [
    'Маскировка', 'Трюк с веревкой', 'Страх', 'Улучшенная невидимость', 'Притворство'
  ],
  'странник горизонта': [
    'Защита от Зла и Добра', 'Туманный шаг', 'Ускорение', 'Изгнание', 'Круг телепортации'
  ],
  'убийца чудовищ': [
    'Защита от Зла и Добра', 'Зона правды', 'Магический круг', 'Изгнание', 'Удержание монстра'
  ],
  'странник фей': [
    'Очаровать персону', 'Туманный шаг', 'Развеять магию', 'Дверь между измерениями', 'ФАЛЬШИВЫЙ ДВОЙНИК'
  ],
  'фейский странник': [
    'Очаровать персону', 'Туманный шаг', 'Развеять магию', 'Дверь между измерениями', 'ФАЛЬШИВЫЙ ДВОЙНИК'
  ],
  'хранитель роя': [
    'Магическая стрела', 'Паутина', 'Газообразная форма', 'Магическое око', 'Нашествие насекомых'
  ],
  ...
  // ── ЧАРОДЕЙ: Происхождения ──
  'аберрантный разум': [
    'Диссонирующий шёпот', 'Руки Хадара', 'Расщепление разума',
    'Обнаружение мыслей', 'Умиротворение',
    'Голод Хадара', 'Послание',
    'Призыв духа аберрации', 'Эвардовы черные щупальца',
    'Ментальная связь Рэри', 'Телекинез'
  ],
  'магия аберраций': [
    'Диссонирующий шёпот', 'Руки Хадара', 'Расщепление разума',
    'Обнаружение мыслей', 'Умиротворение',
  ...
  'заводная душа': [
    'Защита от Зла и Добра', 'Сигнал тревоги',
    'Малое восстановление', 'Подмога',
    'Защита от энергии', 'Развеять магию',
    'Призыв духа конструкта', 'Свобода перемещения',
    'Высшее восстановление', 'Силовая стена'
  ],
  'магия механизма': [
    'Защита от Зла и Добра', 'Сигнал тревоги',
    'Малое восстановление', 'Подмога',
