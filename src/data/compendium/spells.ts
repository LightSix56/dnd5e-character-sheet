...
export const DND_COMPENDIUM_SPELLS: DndSpell[] = [
  ...
  },
  {
    ...
    "description": "Вы демонстрируете небольшое чудо, являющееся знаком вашей сверхъестественной силы. Вы создаете один из следующих эффектов в пределах дальности заклинания: • Ваш голос звучит в три раза громче, чем обычно в течение 1 минуты. • Вы заставляете пламя трепетать, изменить цвет или стать ярче/слабее на 1 минуту. • Вы заставляете землю безвредно дрожать в течение 1 минуты. • Вы создаете мгновенный звук, исходящий из любой точки в пределах дальности заклинания. Это могут быть раскаты грома, карканье ворона или зловещий шепот. • Вы резко открываете или громко захлопываете незакрытую дверь или окно. • Вы изменяете свое обличье для чужого взора на 1 минуту.сли вы произносите это заклинание несколько раз, то можете получить до трех активных одноминутных эффектов за раз. Вы можете отменить такой эффект, потратив действие.",
    "higherLevels": ""
  },
  {
    "name": "Дубинка",
  ...
  },
  {
    ...
    "description": "Вы касаетесь живого существа, которое имеет 0 ОЗ. Состояние существа стабилизируется. Заклинание не действует на нежить или големов.",
    "higherLevels": ""
  },
  {
    "name": "Злая насмешка",
  ...
  },
  {
    ...
    "description": "Вы выпускаете пузырь кислоты. Выберите одну цель в пределах дальности заклинания или две цели, которые находятся в 5 футах друг от друга. Цель должна сделать успешный спасбросок по Ловкости или получит 1d6 урона кислотой. Урон заклинания увеличивается на 1d6, по достижению 5 уровня (2d6), 11 уровня (3d6) и 17 уровня (4d6).",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы протягиваете руку и указываете пальцем на существо в пределах дальности заклинания. Ваша магия на мгновение позволяет вам увидеть слабые места в защите цели. В ваш следующий ход, вы получаете преимущество на первый бросок атаки против этой цели, если заклинание не закончилось.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Сверкающий луч энергии устремляется к цели в пределах дальности заклинания. Сделайте заклинательную атаку дальнего боя. При попадании цель получает 1d10 урона силовым полем. На более высоких уровнях заклинание создает добавочные лучи энергии: два луча на 5 уровне, три луча на 11 уровне и четыре луча 17 уровне. Вы можете направить лучи в одну цель или в разные. Для каждого луча делайте отдельный бросок атаки.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Это заклинание восстанавливает один разлом или разрыв в объекте, которого вы касаетесь. Например сломанное звено цепи, две половинки сломанного ключа, порваный плащ или протекающий бурдюк. Пока разрыв или разлом не больше 1 фута в любой из размерностей, вы полностью исправляете его, не оставляя следов. Заклинание способно физически починить магический предмет или голема, но не может вернуть в него магию.",
    "higherLevels": ""
  },
  {
    "name": "Свет",
  ...
  },
  {
    ...
    "description": "Огненный свет обрушивается на существо, которое вы можете видеть в пределах дальности заклинания. Цель должна сделать спасбросок по Ловкости или получит 1d8 урона излучением. Цель не получает бонусы от укрытий на этот спасбросок. Урон от заклинания увеличивается на 1d8 по достижению 5 уровня (2d8), 11 уровня (3d8) и 17 уровня (4d8).",
    "higherLevels": ""
  },
  {
    "name": "Сообщение",
  ...
  },
  {
    ...
    "description": "Вы касаетесь одного существа. Один раз, пока действует это заклинание, цель может бросить d4 и добавить результат к одному спасброску на свой выбор. Оно может бросить кубик до или после совершения спасброска. После этого заклинание заканчивается.",
    "higherLevels": ""
  },
  {
    ...
    "description": "В вашей руке появляется трепещущее пламя. Оно остается до тех пор, пока действует заклинание, и не наносит вреда вам или вашему снаряжению. Пламя излучает яркий свет в радиусе 10 футов и тусклый свет еще на 10 футов дальше. Заклинание заканчивается, если вы произнесете его снова или отмените в качестве действия. Вы можете атаковать этим пламенем, однако это закончит заклинание. Сразу после произнесения или в качестве действия в один из последующих ходов вы можете метнуть это пламя в существо в пределах 30 футов от вас. Совершите дальнобойную атаку заклинанием. При попадании цель получает 1d8 урона огнем. Урон заклинания увеличивается на 1d8, когда вы достигаете 5 уровня (2d8), 11 уровня (3d8) и 17 уровня (4d8).",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Из вашей руки вырывается молния и шокирует цель, которой вы касаетесь. Сделайте заклинательную атаку ближнего боя против цели. Если она одета в металлические доспехи, то вы получаете преимущество на бросок атаки. При попадании цель получает 1d8 урона электричеством и не может совершать реакции до начала ее следующего хода. Урон этого заклинания увеличивается на 1d8 по достижении 5 уровня (2d8), 11 уровня (3d8) и 17 уровня (4d8).",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы благословляете до трех существ на ваш выбор в пределах дальности заклинания. Каждый раз, когда цель совершает бросок атаки или спасбросок во время действия заклинания, она может бросить d4 и добавить результат к броску атаки или спасброску. На более высоких кругах. Когда вы произносите заклинание, используя ячейку 2 круга или выше, вы можете выбрать одно дополнительное существо за каждый круг выше 1.",
  ...
  },
  {
    ...
    "description": "Ваша молитва наделяет вас божественным сиянием. До конца заклинания ваши атаки оружием наносят дополнительные 1d4 урона излучением.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы испускаете волну оглушительной силы. Каждое существо в 15 футовом кубе должно сделать спасбросок по Телосложению. При провале оно получает 2d8 урона звуком и отталкивается на 10 футов от вас. В случае успеха оно получает половину этого урона и не отталкивается. Кроме того, любые незакрепленные объекты, полностью находящиеся в области действия заклинания, также отталкиваются на 10 футов от вас. Заклинание издает оглушительный гул, который слышно на расстоянии 300 футов. На более высоких кругах. Если вы произносите заклинание, используя ячейку 2 круга или выше, то урон увеличивается на 1d8 за каждый круг выше первого.",
  ...
  },
  {
    ...
    "description": "В вашей руке появляется до десяти ягод, наделенных магией. Любое сущесво может съесть ягоду в качестве действия. Ягода восстанавливает 1 ОЗ и равна дневному запасу еды для 1 существа. Ягоды теряют свою силу, если их не съели в течение 24 часов после произнесения заклинания.",
    "higherLevels": ""
  },
  {
    "name": "Доспехи мага",
    ...
    "description": "Вы касаетесь согласного существа, которое не одето в доспехи, и защитная магия окружает его на время действия заклинания. КБ цели становится 13 + его модификатор Ловкости. Заклинание заканчивается, если цель надевает доспехи или отменяет заклинание в качестве действия.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Заклинание позволяет убедить животное, что вы не причините ему вреда. Выберите существо, которое вы можете видеть в пределах дальности заклинания. Если Интеллект животного 4 или выше, заклинание не срабатывает. В противном случае, существо должно сделать успешный спасбросок по Мудрости, или будет очаровано на время действия заклинания. Если вы или один из ваших компаньонов нанесут вред цели, то заклинание заканчивается. На более высоких кругах. Если вы произносите заклинание, используя ячейку 2 круга или выше, то вы можете воздействовать на одно дополнительное животное за каждый круг выше первого.",
    "higherLevels": ""
  },
  {
    "name": "Жир",
  ...
  },
  {
    ...
    "description": "Существо на ваш выбор, видимое в пределах дистанции, воспринимает все невероятно смешным, и корчится от смеха, если заклинание на него действует. Цель должна преуспеть в спасброске Мудрости, иначе она падает ничком, становится недееспособной, и в течение действия заклинания не может встать. Существа со значением Интеллекта 4 и меньше не попадают под действие этого заклинания. В конце каждого своего хода, и каждый раз при получении урона цель может совершать новый спасбросок Мудрости. Спасбросок совершается с преимуществом, если он был вызван получением урона. При успехе заклинание оканчивается.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы создаете три сверкающих заряда магической энергии. Каждый заряд попадает в выбранное вами существо в пределах дальности заклинания. Заряд наносит 1d4 + 1 урона силовым полем. Все заряды наносят удар одновременно, и вы можете направить их в одну цель или в несколько. На более высоких кругах. Если вы произносите заклинание, используя ячейку 2 круга или выше, то заклинание создает один дополнительный заряд за каждый круг выше первого.",
  ...
  },
  {
    ...
    "description": "Реакция, которую вы совершаете, когда вы или существо в пределах 60 футов от вас падает Выберите до пяти падающих существ в пределах дальности заклинания. Скорость падения существ снижается до 60 футов за раунд, пока не закончится заклинание. Если существо приземлятеся до окончания заклинания, то оно не получает урона от падения и может приземлиться на ноги. После этого заклинание заканчивается.",
    "higherLevels": ""
  },
  {
    "name": "Метка охотника",
  ...
  },
  {
    ...
    "description": "Вы пишете на пергаменте, бумаге или другом подходящем материале и создаете на нем иллюзию, которая длится до тех пор, пока действует заклинание. Для вас и существ, которых вы выбрали при произнесении заклинания, текст выглядит обычным, написанным вашей рукой. Для всех остальных текст написан на неизвестном и непонятном языке. Альтернативно, вы можете сделать так, чтобы текст выглядел как абсолютно другое сообщение, написанное другой рукой и на другом языке, но вы должны знать этот язык. Если заклинание развеяно, то исчезает как оригинальный текст, так и иллюзия. Существо с истинным зрением может прочитать скрытое сообщение.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Пока действует заклинание, вы чувствуете наличие и местоположение ядов, ядовитых существ и болезней в пределах 30 футов вокруг вас. Вы также узнаете тип каждого яда, ядовитого существа и болезни. Заклинание проходит через большинство препятствий, но его останавливает камень толщиной 1 фут, металл толщиной 1 дюйм, тонкий слой свинца, дерево или земля толщиной 3 фута.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Пока действует заклинание, вы получаете способность понимать и вербально общаться с животными. Разум и сознание большинства животных ограничивается их Интеллектом, но как минимум, они могут сообщить вам информацию о близлежащих областях и монстрах, а также то, что они видели в течение последнего дня. По усмотрению МП вы можете убедить животное выполнить для вас небольшое поручение.",
    "higherLevels": ""
  },
  {
    "name": "Опутывание",
  ...
  },
  {
    ...
    "description": "Вся немагическая пища и напитки в сфере радиусом 5 футов вокруг указанной вами точки в пределах дальности очищается от ядов и болезней.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Это заклинание позволяет вам двигаться с невероятной скоростью. Сразу после произнесения и в качестве дополнительного действия каждый следующий ход, пока заклинание действует, вы можете совершать Рывок.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы касаетесь существа. Пока действует заклинание, его дальность прыжка увеличивается втрое.",
    "higherLevels": ""
  },
  {
    "name": "Псевдожизнь",
    ...
    "description": "Наделяя себя некромантским подобием жизни, вы получаете 1d4 +4 временных ОЗ, пока действует заклинание. На более высоких кругах. Если вы произносите заклинание, используя ячейку 2 круга или выше, то получаете 5 временных ОЗ дополнительно за каждый круг выше первого.",
  ...
  },
  {
    ...
    "description": "Вы касаетесь существа и его скорость увеличивается на 10 футов, пока действует заклинание. На более высоких кругах. Если вы произносите заклинание, используя ячейку 2 круга или выше, то можете использовать это заклинание на одно дополнительное существо за каждый круг выше первого.",
  ...
  },
  {
    ...
    "description": "Вы защищаете существо в пределах дальности заклинания от атаки. Пока заклинание действует, любое существо, которое атакует защищенную цель или использует на нее вредоносное заклинание, должно сделать спасбросок по Мудрости. При провале существо должно выбрать другую цель или потерять эту атаку или заклинание. Заклинание не защищает цель от эффектов, действующих на область, например от взрыва огненного шара. Если защищенная цель атакует или произносит заклинание, которое воздействует на враждебное существо, то заклинание заканчивается.",
    "higherLevels": ""
  },
  {
    "name": "Хаос-болт",
  ...
  },
  {
    ...
    "description": "Мерцающее поле окружает выбранное вами существо в пределах дальности заклинания, даруя ему +2 к КБ на время действия заклинания.",
    "higherLevels": ""
  },
  {
    "name": "Вечный огонь",
    ...
    "description": "Пламя, равное по яркости факелу, возникает из объекта, которого вы коснулись. Эффект выглядит как обычное пламя, но оно не производит тепла и не расходует кислород. Вечный огонь можно закрыть или спрятать, но его нельзя ни погасить, ни потушить.",
    "higherLevels": ""
  },
  {
    "name": "Вибрация",
    ...
    "description": "Внезапный громкий звенящий звук раздается в указанном вами месте в пределах дальности заклинания. Каждое существо, находящееся в радиусе 10 футов вокруг этой точки, должно сделать спасбросок по Телосложению. При неудаче существо получает 3d8 урона звуком, а при успехе - половину этого урона. Существа, состоящие из неорганических материалов, например,таких как камень, кристалл или металл, получают помеху при спасброске. Немагические предметы, которые не несут и не носят, также получают урон, оказавшись в зоне действия заклинания. На более высоких кругах. Когда вы произносите это заклинание, используя ячейку 3 круга или выше, урон увеличивается на 1d8 за каждый круг выше 2.",
  ...
  },
  {
    ...
    "description": "Во время действия заклинания вы видите невидимых существ и объекты, слово они видимые. Кроме того вы можете видеть в Эфирном Плане. Эфирные существа и объекты кажутся вам призрачными и полупрозрачными.",
    "higherLevels": ""
  },
  {
    "name": "Внушение",
    ...
    "description": "Вы внушаете образ действий (ограниченный одним-двумя предложениями) и магически влияете на существо, которое вы можете видеть в пределах дальности заклинания. Существо должно слышать и понимать вас. Существа, которых нельзя очаровать, имунны к воздействию этого заклинания. Внушение должно казаться существу рациональным. Существо должно сделать спасбросок по Мудрости. При неудаче оно следует указанному вами образу действий по мере своих возможностей. Этот образ действий может длиться на всем протяжении заклинания. Если его можно закончить раньше, то заклинание заканчивается, когда существо выполняет то, о чем вы его попросили. Вы можете указывать конкретные условия, в которых существо будет действовать определенным образом. Если вы или любой из ваших компаньонов наносит урон цели, то заклинание заканчивается.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы касаетесь согласного существа. Пока заклинание не закончится, кожа цели становится грубой и похожей на кору. КБ существа не может опуститься ниже 16, независимо от одетых на нем доспехов.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Мерцающая зеленая стрела устремляется к цели в пределах дальности заклинания и взрывается, разбрызгивая кислоту. Сделайте заклинательную атаку дальнего боя против цели. В случае попадания цель немедленно получает 4d4 урона кислотой и еще 2d4 урона кислотой в конце её следующего хода. В случае промаха, стрела задевает цель брызгами кислоты, нанося половину начального урона, и не нанося последующего урона. На более высоких кругах. Если вы произносите заклинание, используя ячейку 3 круга или выше, то урон (как начальный, так и последующий) увеличивается на 1d4 за каждый круг выше второго.",
  ...
  },
  {
    ...
    "description": "Пока действует заклинание, ваше следующее попадание оружием сопровождается мерцанием астрального света. Удар наносит дополнительные 2d6 урона излучением, а цель становится видимой, если была невидимой, и начинает светиться тусклым светом в радиусе 5 футов. Пока заклинание не закончится, цель не может стать невидимой. На более высоких кругах. Когда вы произносите заклинание, используя ячейку 3 круга или выше, дополнительный урон увеличивается на 1d6 за каждый круг выше второго.",
  ...
  },
  {
    ...
    "description": "В вашей свободной руке появляется огненный клинок. По форме и размеру он похож на скимитар. Клинок исчезает, если вы выпускаете его из руки, но вы можете призвать его снова в качестве дополнительного действия. В качестве действия вы можете сделать рукопашную атаку заклинанием. При попадании цель получает 3d6 урона огнем. Клинок пламени излучает яркий свет в радиусе 10 футов и тусклый свет еще на 10 футов дальше. На более высоких кругах. Если вы произносите заклинание, используя ячейку 4 круга или выше, то урон увеличивается на 1d6 за каждые 2 круга выше второго.",
  ...
  },
  {
    ...
    "description": "Черный луч обессиливающей энергии устремляется с вашего пальца в выбранную цель в пределах дальности заклинания. Сделайте заклинательную атаку дальнего боя против этой цели. При попадании цель будет наносить лишь половину урона атаками, использующими Силу, пока не закончится действие заклинания. В конце каждого хода, цель может сделать спасбросок по Телосложению, чтобы освободиться от заклинания. При успехе оно заканчивается.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Вы касаетесь существа и можете снять одну болезнь или другое состояние, которое воздействует на него. Это может быть слепота, глухота, паралич или яд.",
    "higherLevels": ""
  },
  {
    "name": "Невидимость",
  ...
  },
  {
    ...
    "description": "Вы касаетесь трупа или других останков. Пока действует заклинание, цель защищена от разложения и не может стать нежитью. Заклинание также эффективно увеличивает ограничение по времени на воскрешение цели, поскольку время, проведенное под воздействием этого заклинания, не учитывается временным ограничением таких заклинаний, как поднять мертвого.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Опишите или назовите определенный вид животного или растения. Концентрируясь на звуках природы вокруг вас, вы узнаете направление и расстояние ближайшего животного или растения этого вида в пределах 5 миль, если таковое имеется.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы касаетесь одного согласного существа, и пока действует заклинание, оно получает способность передвигаться вверх и вниз по вертикальных поверхностям или вверх ногами по потолку, не используя руки. Существо также получает скорость лазания, равную его наземной скорости.",
    "higherLevels": ""
  },
  {
    "name": "Подмога",
    ...
    "description": "Заклинание наделяет ваших союзников стойкостью и решимостью. Выберите до 3 существ в пределах дальности заклинания. Их максимальное и текущее количество ОЗ увеличивается на 5 до тех пор, пока действует заклинание. На более высоких кругах. Если вы произносите заклинание, используя ячейку 3 круга или выше, то дополнительные ОЗ увеличиваются на 5 за каждый круг выше второго.",
  ...
  },
  {
    ...
    "description": "Вы принимаете другую форму. Выберите один из следующих вариантов, который вступит в действие. Вы можете отменить выбранный вариант в качестве действия и выбрать новый. Водная форма. Вы можете принять форму, подходящую для подводных условий, получая жабры и перепонки между пальцами. Вы можете дышать под водой и получаете водную скорость, которая равна вашей наземной скорости. Изменение внешности. Вы изменяете свой внешний вид, выбирая свой рост, вес, черты лица, голос, длину и цвет волос, а также отличительные характеристики. Пока заклинание действует, вы можете изменить свою внешность в качестве действия. Природное оружие. У вас появляются когти, клыки, шипы, рога или другое природное оружие на ваш выбор. Ваши безоружные атаки наносят 1d6 дробящего, режущего или колющего урона в зависимости от выбранного природного оружия и вы получаете владение безоружным боем. Кроме того, природное оружие считается магическим и имеет бонус +1 к броскам атаки и урона.",
    "higherLevels": ""
  },
  {
    "name": "Стук",
  ...
  },
  {
    ...
    "description": "Вы касаетесь согласного существа, даруя ему способность видеть в темноте. Пока действует заклинание, существо имеет темновидение в радиусе 60 футов.",
    "higherLevels": ""
  },
  {
    "name": "Тишина",
  ...
  },
  {
    ...
    "description": "Вас на мгновение окружает серебряная дымка, после чего вы перемещаетесь на расстояние до 30 футов в незанятое место, которое можете видеть.",
    "higherLevels": ""
  },
  {
    "name": "Тьма",
  ...
  },
  {
    ...
    "description": "Вы призываете духов, защищающих вас. Они летают вокруг вас на расстоянии 15 футов, пока действует заклинание. Если ваше мировоззрение доброе или неитральное, то они принимают форму ангелов или фей (на ваш выбор). Если вы злой, то они принимают форму демонических существ. Когда вы произносите заклинание, вы выбираете любое количество существ, не подверженных его действию. Другие существа замедляются вдвое, находясь в области заклинания. Когда существо впервые заходит в зону действия, оно должно сделать спасбросок по Мудрости. При провале оно получает 3d8 урона излучением (если вы добрый или неитральный) или 3d8 некротического урона (если вы злой). В случае успешного спасброска существо получает только половину этого урона. На более высоких кругах. Если вы произносите заклинание, используя ячейку 4 круга или выше, то урон увеличивается на 1d8 за каждый круг выше третьего.",
  ...
  },
  {
    ...
    "description": "Пока действует заклинание, существо, которого вы коснулись получает сопротивление к одному типу урона на ваш выбор: кислота, холод, огонь, молния или звук.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Удар молнии формирует волну длиной 100 футов и шириной 5 футов, которая распространяется в указанном вами направлении. Каждое существо в зоне действия должно сделать спасбросок по Ловкости. При провале оно получает 8d6 урона электричеством, а при успехе - половину этого урона. Молния поджигает любые воспламеняющиеся объекты, которые не находятся во владении существ. На более высоких кругах. Если вы произносите заклинание, используя ячейку 4 круга или выше, то урон увеличивается на 1d6 за каждый круг выше третьего.",
  ...
  },
  {
    ...
    "description": "Вы касаетесь существа, которое умерло не более минуты назад. Это существо возвращается к жизни с 1 ОЗ. Оно не может вернуть к жизни существо, которое умерло от старости, и не может вернуть потерянные части тела.",
    "higherLevels": ""
  },
  {
    "name": "Охранные руны",
  ...
  },
  {
    ...
    "description": "Благодаря этому заклинанию до десяти согласных существ, которых вы можете видеть в пределах дальности заклинания, получают способность дышать под водой до тех пор, пока действует заклинание. Существа сохраняют свой обычный способ дыхания.",
    "higherLevels": ""
  },
  {
    "name": "Полет",
  ...
  },
  {
    ...
    "description": "Вы касаетесь одного существа или объекта, снимая с него все проклятия. Если объектом является проклятый магический предмет, то проклятие сохраняется, однако заклинание разрушает привязку объекта к владельцу, в результате чего предмет можно снять или выбросить.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Вы создаете 45 фунтов пищи и 30 галлонов воды на земле или в емкостях в пределах дальности заклинания. Этого хватает, чтобы накормить пятнадцать гуманоидов или пять скакунов в течение 24 часов. Еда простая, но питательная, и портится, если ее не съесть за 24 часа. Вода чистая и не портится.",
    "higherLevels": ""
  },
  {
    "name": "Стена ветра",
  ...
  },
  {
    ...
    "description": "Заклинание дарует способность двигаться по любой жидкой поверхности, например по воде, кислоте, грязи, снегу, зыбкому песку или лаве, словно это безвредная твердая поверхность (существа, двигающиеся по жидкой лаве, будут получать урон от жара). Вы можете выбрать до десяти согласных существ, которых видите в пределах дальности заклинания. Если цель заклинания находится под водой, то она начинает подниматься на поверхность со скоростью 60 футов за раунд.",
    "higherLevels": ""
  },
  {
    "name": "Языки",
    ...
    "description": "Вы касаетесь существа и даруете ему способность понимать любой разговорный язык, который он слышит. А когда цель говорит, любое существо, которое знает хотя бы один язык и может слышать, понимает её.",
    "higherLevels": ""
  },
  {
    "name": "Ясновидение",
  ...
  },
  {
    ...
    "description": "Вы касаетесь существа и даруете ему защиту от смерти. Первый раз, когда ОЗ цели должны упасть до 0 в результате получения урона, ее ОЗ вместо этого падают до 1, а заклинание заканчивается. Если заклинание все еще действует, когда цель подвергается эффекту, который бы убил ее на месте без нанесения урона, то этот эффект не срабатывает, а заклинание заканчивается.",
    "higherLevels": ""
  },
  {
    "name": "Защитник веры",
  ...
  },
  {
    ...
    "description": "Вы создаете в пределах дистанции защищенное магией место. Это куб с длиной ребра от 5 до 100 фт. Заклинание длится, пока не окончится, или вы не окончите его действием. Когда вы накладываете это заклинание, вы решаете, какую именно безопасность обеспечивает заклинание, выбирая все или некоторые из следующих свойств: Звуки не проходят сквозь границу защищенного пространства. Граница защищенного пространства выглядит темной и затуманенной, блокируя обзор (в том числе и темное зрение) сквозь нее. Сенсоры, создаваемые заклинаниями школы Прорицания, не могут появляться в защищенной области и проходить сквозь ее периметр. Существа в области не могут становиться целями заклинаний школы Прорицания. Ничто не может телепортироваться в охраняемую область или из нее. В охраняемой области блокируются планарные перемещения. Накладывание этого заклинания на одно и то же место в течение года делает этот эффект постоянным. На больших уровнях . Если вы накладываете это заклинание, используя ячейку 5 уровня или выше, вы можете увеличить размер куба на 100 фт. за каждый уровень ячейки выше 4. Таким образом, это заклинание, использованное ячейкой 5 уровня, может создать куб с длиной ребра 200 фт.",
  ...
  },
  {
    ...
    "description": "Вы касаетесь согласного существа и делаете его кожу твердой как камень. Пока действует заклинание, цель имеет сопротивление к немагическому ударному, колющему и режущему урону.",
    "higherLevels": ""
  },
  {
    "name": "Ледяной шторм",
  ...
  },
  {
    ...
    "description": "Вы призываете элементалей, которые появляются в незанятых местах, которые вы можете видеть в пределах дальности заклинания. Выберите один из следующих вариантов: • Один элементаль с уровнем опасности 2 или ниже • Два элементаля с уровнем опасности 1 или ниже • Четыре элементаля с уровнем опасности 1/2 или ниже • Восемь элементалей с уровнем опасности 1/4 или ниже Элементаль исчезает, когда его ОЗ падают до 0, или когда заклинание заканчивается. Существа подчиняются вашим вербальным приказам (действия не требуется). Если вы не отдаете никаких приказов, то существа только защищают себя от враждебных существ. На более высоких кругах. Если вы произносите заклинание, используя ячейки более высокого круга, то можете вызвать больше существ: в два раза больше за ячейку 6 круга и в три раза больше за ячейку 8 круга.",
    "higherLevels": "When you cast this spell using certain higher-level spell slots, you choose one of the summoning options above, and more creatures appear: twice as many with a 6th-level slot and three times as many with an 8th-level slot."
  },
  {
    "name": "Принуждение",
  ...
  },
  {
    ...
    "description": "Вы или существо, которого вы коснулись, невидимы до тех пор, пока действует заклинание. Любое снаряжение цели также становится невидимым, пока оно находится у нее.",
    "higherLevels": ""
  },
  {
    "name": "Усыхание",
  ...
  },
  {
    ...
    "description": "Черные извивающиеся щупальца заполняют квадрат на полу с длиной стороны 20 фт., который вы видите в пределах дистанции. Пока заклинание активно, эти щупальца делают местность труднопроходимой. огда существо впервые за ход входит в область заклинания или начинает там ход, оно должно преуспеть в спасброске Ловкости, иначе получит дробящий урон 3d6 и станет @JournalEntry[Опутанным] щупальцами до окончания заклинания. Существо, начинающее ход в этой области, уже @JournalEntry[Опутанное] щупальцами, получает дробящий урон 3d6. A creature @JournalEntry[Опутанное] щупальцами существо может действием совершить проверку Силы или Ловкости (на свой выбор) против Сл ваших заклинаний. В случае успеха оно высвобождается.",
    "higherLevels": ""
  },
  {
    "name": "Вещий сон",
  ...
  },
  {
    ...
    "description": "Вы можете видеть и слышать определенное существо на ваш выбор, которое находится на одном плане с вами. Выбранная вами цель должна сделать спасбросок по Мудрости. Если цель знает о том, что вы произносите заклинание, она может добровольно провалить спасбросок, если хочет, чтобы за ней наблюдали. При успешном спасброске, заклинание не срабатывает, и вы не можете использовать его на эту цель повторно в течение 24 часов. При провале, заклинание создает невидимый сенсор в пределах 10 футов от цели. Вы можете видеть и слышать через него, словно вы сами находитесь там. Сенсор двигается вместе с целью, оставаясь в пределах 10 футов от нее. Существо, которое может видеть невидимые объекты, видит сенсор, который выглядит как светящийся шар размером с кулак. Вместо наблюдения за существом, вы можете выбрать место, которое видели прежде, в качестве цели заклинания.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Это заклинание позволяет вам изменить внешний вид любого числа существ. Вы даете каждому существу новый иллюзорный вид. Несогласное существо может сделать спасбросок по Харизме. Заклинание маскирует физическую внешность, а также одежду, доспехи, оружие и снаряжение. Вы можете сделать так, что существо будет казаться ниже или выше на 1 фут, а также толще или стройнее. Изменения, созданные этим заклинанием, легко заметны при физическом обследовании. Чтобы раскрыть маскировку, существо может обследовать вашу внешность в качестве действия и совершить успешную проверку Интеллекта (Анализ) против вашего КС заклинаний.м вы на самом деле, то любой, кто близко подойдет к вам, столкнется с вашей невидимой частью. Чтобы раскрыть маскировку, существо может обследовать вашу внешность в качестве действия и совершить успешную проверку Интеллекта (Анализ) против вашего КС заклинаний.",
    "higherLevels": ""
  },
  {
    "name": "Пробуждение",
  ...
  },
  {
    ...
    "description": "Вы получаете способность передвигать объекты и существ или манипулировать ими. Когда вы произносите заклинание и в качестве действия каждый последующий ход, пока действует заклинание, вы можете оказать воздействие на одно существо или объект. Существо. Вы можете передвинуть существо Большого или меньшего размера. Сделайте проверку заклинательного параметра против проверки Силы существа. Если вы победили в противостоянии, то передвиньте существо на расстояние до 30 футов в любом направлении, включая верх. Объект. Вы можете передвинуть объект весом не более 1000 фунтов. Если объект не одет и не находится в руках существа, вы автоматически можете передвинуть его на расстояние до 30 футов. Если объект одет или находится в руках существа, вы должны сделать проверку вашего заклинательного параметра против проверки Силы существа. При победе вы отнимаете объект у существа и можете передвинуть его на расстояние до 30 футов. Телекинетический захват позволяет совершать точные действия.",
    "higherLevels": ""
  },
  {
    "name": "Телепатическая Связь (Telepathic Bond)",
  ...
  },
  {
    ...
    "description": "Вертикальная колонна божественного пламени с ревом устремляется с небес в указанную вами точку. Каждое существо в цилиндре радиусом 10 футов и высотой 40 футов вокруг указанной вами точки должно сделать спасбросок по Ловкости. При провале существо получает 4d6 урона огнем и 4d6 урона излучением, а при успехе - половину этого урона. На более высоких кругах. Если вы произносите заклинание, используя ячейку 6 круга или выше, то урон огнем или излучением (на ваш выбор) увеличивается на 1d6 за каждый круг выше пятого.",
  ...
  },
  {
    ...
    "description": "Выберите существо, которое вы можете видеть в пределах дальности заклинание. Цель должна сделать спасбросок по Мудрости или будет парализована на время действия заклинания. Заклинание не действует на нежить. В конце каждого своего хода цель может сделать новый спасбросок по Мудрости. В случае успеха заклинание заканчивается для этой цели. На более высоких кругах. Если вы произносите заклинание, используя ячейку 6 круга или выше, то можете использовать его на одну дополнительную цель за каждый круг выше пятого. Существа должны находиться в пределах 30 футов друг от друга, когда вы произносите заклинание.",
  ...
  },
  {
    ...
    "description": "Тонкий зеленый луч вылетает из вашего указательного пальца в выбранную цель. Целью может быть существо, объект или проявление магической силы, например стена, созданная заклинанием силовая стена. Цель должна сделать спасбросок по Ловкости. При провале цель получает 10d6 + 40 урона силовым полем. Если этот урон снижает ОЗ существа до 0, то оно дезинтегрируется. Дезинтегрированное существо и всё его снаряжение, за исключением магических предметов, превращается в кучку серой пыли. Такое существо можно вернуть к жизни только заклинаниями истинное воскрешение или исполнение желаний. Заклинание автоматически дезинтегрирует объект Большого или меньшего размера, или проявление магической силы. Если объект или проявление магической силы Огромного или еще более крупного размера, то заклинание дезинтегрирует участок объемом 10 кубических футов. Магические предметы невосприимчивы к этому заклинанию. На более высоких кругах. Используя ячейку 7 круга или выше, урон увеличивается на 3d6 за каждый круг выше шестого.",
  ...
  },
  {
    ...
    "description": "Вы касаетесь предмета, весящего не более 10 фунтов, и достигающего в длину не более 6 фт. Заклинание оставляет невидимую метку на его поверхности и невидимое название предмета на сапфире, использованном в качестве материального компонента. При каждом использовании этого заклинания вы должны использовать новый сапфир. В любой момент впоследствии вы можете действием произнести название предмета и раздавить сапфир. Предмет мгновенно появляется в вашей руке, вне зависимости от расстояния и планов, разделяющих вас, а заклинание оканчивается. Если этот предмет несёт или держит другое существо, уничтожение сапфира не переносит предмет к вам, но вы узнаёте, кто им сейчас владеет, и где это существо сейчас примерно находится. Рассеивание магии и аналогичные эффекты, успешно наложенные на сапфир, оканчивают эффект заклинания.",
    "higherLevels": ""
  },
  {
    "name": "Заданный образ",
  ...
  },
  {
    ...
    "description": "Вы касаете согласного существа и даруете ему способность видеть вещи такими, какие они есть. Пока действует заклинание, существо получает истинное зрение, оно видит любые двери и предметы, скрытые магией, и может видеть Эфирный План на расстоянии 120 футов.",
    "higherLevels": ""
  },
  {
    "name": "Круг смерти",
    ...
    "description": "Шар отрицательной энергии радиусом 60 футов появляется в указанной вами точке в пределах дальности заклинания. Каждое существо в этой области должно сделать спасбросок по Телосложению. В случае провала оно получает 8d6 некротического урона, а в случае успеха - половину этого урона. На более высоких кругах. Если вы произносите заклинание, используя ячейку 7 круга или выше, урон увеличивается на 2d6 за каждый круг выше шестого.",
  ...
  },
  {
    ...
    "description": "Выберите существо, которое вы можете видеть в пределах дальности заклинания. Волна положительной энергии проходит сквозь это существо и восстанавливает ему 70 ОЗ. Заклинание также излечивает слепоту, глухоту и любые болезни. Оно не действует на нежить или големов. На более высоких кругах. Если вы произносите заклинание, используя ячейку 7 круга или выше, то объем исцеления увеличивается на 10 за каждый круг выше шестого.",
  ...
  },
  {
    ...
    "description": "Это заклинание создает магическую связь между растением крупнее Среднего размера и другим растением на любом расстоянии в пределах того же плана существования. Вы должны были видеть намеченное растение или касаться его хотя бы раз. Пока действует заклинание, любое существо может войти растение, которое было целью заклинания и выйти из намеченного, расходуя 5 футов перемещения.",
    "higherLevels": ""
  },
  {
    "name": "Пир Героев",
  ...
  },
  {
    ...
    "description": "Вы создаёте стену из крепких, гибких, перевитых кустов с острыми как иглы шипами. Стена появляется в пределах дистанции на твёрдой поверхности и существует, пока активно заклинание. Вы можете сделать стену до 60 футов в длину, до 10 футов в высоту и толщиной 5 футов или кругом с диаметром 20 футов, высотой до 20 футов и толщиной 5 футов. Эта стена блокирует линию обзора. Когда стена появляется, все существа, находящиеся в ней, должны совершить спасбросок Ловкости. При провале существо получает колющий урон 7к8, или половину этого урона при успехе. Существа могут проходить сквозь стену, но медленно и болезненно. За каждый 1 фут перемещения через стену существо должно потратить 4 фута перемещения. Кроме того, в первый раз за ход, когда существо входит в стену или оканчивает там ход, оно должно совершать спасбросок Ловкости. Оно получает рубящий урон 7к8 при провале, или половину этого урона при успехе. На больших уровнях: Если вы накладываете это заклинание, используя ячейку 7 уровня или выше, оба вида урона увеличиваются на 1к8 за каждый уровень ячейки выше шестого.",
  ...
  },
  {
    ...
    "description": "Вы наносите губительный знак на какую-либо поверхность или внутри объекта. Чтобы его обнаружить требуется успешная проверка Интеллекта (Анализ) против вашего КС заклинаний. Смерть. Каждое существо делает спас. по Телосложению, при провале получая 10d10 некротического урона, а в случае успеха - половину этого урона. Разлад. Каждое существо спорит и ругается с другими существами в течение 1 минуты. Страх. Каждое существо напугано в течении 1 минуты. Безвыходность. Каждую цель охватывает отчаяние на 1 минуту. Безумие. Каждое существо сходит с ума на 1 минуту. Боль. Каждое существо страдает от мучительной боли в течение 1 минуты. Сон. Каждое существо теряет сознание на 10 минут. Оглушение. Каждая цель оглушается на 1 минуту.",
    "higherLevels": ""
  },
  {
    "name": "Изоляция",
  ...
  },
  {
    ...
    "description": "Вы создаёте сгусток силового поля в форме меча, парящий в пределах дистанции. Он существует, пока активно заклинание. Когда меч появляется, вы совершаете рукопашную атаку заклинанием по цели на ваш выбор, находящейся в пределах 5 фт. от меча. При попадании цель получает урон силовым полем 3d10. Пока заклинание активно, вы можете в каждом своём ходу бонусным действием перемещать меч на 20 фт. в видимое место, и повторять эту атаку по той же самой или другой цели. Пока заклинание активно, вы можете использовав бонусное действие для перемещения меча на 20 футов к месту которые вы видите и совершить атаку против этой же цели или другой.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Заклинание обращает силу притяжения в цилиндре радиусом 50 футов и высотой 100 футов вокруг указанной вами точки в пределах дальности заклинания. Все существа и объекты, которые не удерживаются на земле каким-либо образом, начинают падать вверх, пока не достигнут вершины области действия. Существо может сделать спасбросок по Ловкости, чтобы успеть схватиться за какой-либо закрепленный объект и остаться на земле. Если на пути падения встречается твердый объект (например потолок), то падающие объекты и существа ударяются об него как при обычном падении. Если объект или существо достигают вершины области заклинания, то они остаются там, пока оно действует, слегка покачиваясь. После окончания заклинания, объекты и существа падают обратно.",
    "higherLevels": ""
  },
  {
    "name": "Огненная буря",
  ...
  },
  {
    ...
    "description": "Вы изменяете местность площадью до 1 квадратной мили так, что она выглядит, издает звуки, пахнет и даже воспринимается на ощупь как другой вид местности. Однако общая форма местности остается прежней. Поля или дорога могут стать болотом, холмами, расщелинами или другой непроходимой местностью, пруд - лугом, поросшим травой, пропасть - пологим склоном, а усыпанный камнями овраг - ровной дорогой. Вы можете также изменять внешний вид строений, или добавлять новые там, где их нет. Заклинание не маскирует, скрывает или добавляет существ. Иллюзия включает в себя звуковые, визуальные, тактильные и обонятельные элементы, поэтому вы можете превратить ровную местность в труднопроходимую (и наоборот) или иным образом препятствовать передвижению в этой области. Любая часть иллюзии, вынесенная за пределы действия заклинания, мгновенно исчезает.",
    "higherLevels": ""
  },
  {
    "name": "Телепортация",
  ...
  },
  {
    ...
    "description": "Пока действует заклинание, всякий раз, когда вы делаете проверку по Харизме, вы можете заменить результат броска на 15. Кроме того, независимо от того, что вы говорите, магия, которая определяет правдивость ваших слов, всегда считает, что вы говорите правду.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Яркий солнечный свет вспыхивает в выбранной вами точке в пределах дальности заклинания, заполняя сферу радиусом 60 футов. Каждое существо, которое оказалось в этой сфере, должно сделать спасбросок по Телосложению. При провале существо получает 12d6 урона излучением и ослепляется на одну минуту. При успехе существо получает половину этого урона и не ослепляется. Нежить и слизни получают помеху на этот спасбросок. Ослепленное этим заклинанием существо делает еще один спасбросок по Телосложению в конце каждого своего хода. В случае успеха слепота проходит. Данное заклинание рассеивает любую тьму магического происхождения в области действия.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы создаете магическим способом ограничиваете существо. Цель должна сделать успешный спасбросок по Мудрости. В случае успеха, оно получает иммунитет к этому заклинанию. Погребение. Цель заточается глубоко под землей в магической сфере. Оковы. Тяжелые цепи, прочно закрепленные в замке, удерживают цель на месте. Огражденная тюрьма. Заклинание перемещает цель в маленькое подпространство. Крохотное узилище. Цель уменьшается до размером 1 дюйма и помещается внутри драгоценного камня. Глубокий сон. Цель засыпает, и ее нельзя разбудить никаким образом. Окончание заклинания. Во время произношение заклинания, вы можете указать условие, при котором оно закончится и освободит цель.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Огромная волна целительной энергии исходит от вас. Вы восстанавливаете до 700 ОЗ, которые можете распределить между любым количеством существ, которых вы видите в пределах дальности заклинания. Существа, которых лечит это заклинание, также исцеляются от любых болезней и эффектов, которые вызывают слепоту или глухоту. Заклинание не действует на нежить или големов.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Пылающие шары падают на землю в четырех разных местах, которые вы можете видеть в пределах дальности заклинания. Каждое существо, которое находится в сфере радиусом 40 футов вокруг места падения, должно сделать спасбросок по Ловкости. При провале существо поулчает 20d6 огненного урона и 20d6 дробящего урона, а при успехе - половину этого урона. Существо, оказавшееся в области падения нескольких шаров, получает урон только раз. Заклинание повреждает объекты в области действия и поджигает любые воспламеняющиеся объекты, которые не находятся во владении других существ.",
    "higherLevels": ""
  },
  {
  ...
  },
  {
    ...
    "description": "Вы произносите слово силы, которое заставляет мгновенно умереть одно существо в пределах дальности заклинания. Если выбранное вами существо имеет 100 ОЗ или меньше, то оно умирает. Иначе заклинание не срабатывает.",
    "higherLevels": ""
  },
  {
    "name": "Смертный ужас",
  ...
  },
  {
    ...
    "description": "Первый раз, когда вы попадаете атакой рукопашным оружием во время действия заклинания, ваше оружие издает оглушительный грохот, слышимый в пределах 300 футов, и атака наносит дополнительно 2d6 урона звуком цели. Кроме того, если цель — существо, она должна преуспеть в спасброске Силы, иначе будет оттолкнута на 10 футов от вас и сбита с ног.",
    "higherLevels": ""
  },
  {
    "name": "Гневная кара",
    ...
    "description": "Первый раз, когда вы попадаете атакой рукопашным оружием во время действия этого заклинания, ваша атака наносит дополнительно 1d6 психического урона. Кроме того, если цель — существо, она должна сделать спасбросок Мудрости. При провале она становится испуганной вами до тех пор, пока заклинание не закончится.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Первый раз, когда вы попадаете атакой рукопашным оружием во время действия заклинания, ваше оружие вспыхивает белым пламенем, и атака наносит дополнительно 1d6 урона огнем и поджигает цель. В начале каждого своего хода цель должна делать спасбросок Телосложения. При провале она получает 1d6 урона огнем.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Первый раз, когда вы попадаете атакой рукопашным оружием во время действия заклинания, ваше оружие сияет ярким светом, и атака наносит дополнительно 3d8 урона излучением цели. Кроме того, цель должна преуспеть в спасброске Телосложения, иначе станет ослепленной до окончания заклинания.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Первый раз, когда вы попадаете атакой рукопашным оружием во время действия заклинания, ваше оружие пронзает и тело, и разум. Атака наносит дополнительно 4d6 психического урона. Цель должна совершить спасбросок Мудрости. При провале она получает помеху на броски атак и проверки характеристик, а также не может совершать реакции до конца своего следующего хода.",
    "higherLevels": ""
  },
  {
    ...
    "description": "Первый раз, когда вы попадаете атакой рукопашным оружием во время действия заклинания, ваше оружие потрескивает невидимой силой, и атака наносит дополнительно 5d10 силового урона. Если эта атака снижает хиты цели до 50 или меньше, вы изгоняете ее на родной план бытия (или в демиплан).",
    "higherLevels": ""
  }
];
